...
class SpectrogramService
{
    ...
    /**
     * @var SoundImageService
     */
    private $soundImageService;

    /**
     * SpectrogramService constructor.
     * @param int $fftSize
     */
    public function __construct(int $fftSize = 1014)
    {
        $this->soundImageService = new SoundImageService();
    ...
    public function generateImages(array $sound): void
    {
        ...
        $this->soundImageService->deleteByRecording($sound[Recording::ID]);
