...
class UserController {
	...
	private function getUsersList(){	
		...
		foreach($listUsers as $userData) {
			...
			$this->view->listUsers .= '<td><div class="input-group colorpicker-component"><input type="hidden" name="TagColor" value=' . $userTagColor . '"><span class="input-group-addon tag-color"><i title="Change user tags color"></i></span></div></td>';
